...
| Confirmed Manager workspace boundary | [Manager Operations Workspace Decision](decisions/MANAGER_OPERATIONS_WORKSPACE_DECISION.md) |
| Full Manager operating journey | [Manager Store Operations](journeys/MANAGER_STORE_OPERATIONS.md) |
